				...
				<div class="row">
					<div class="container">
						<ol class="breadcrumb breadcrumb-arrow">
							...
							<li class="active"><span><i class="fa fa-info-circle"></i> Materi Guru <?= $guru->nama ?> </span></li>
						</ol>
					</div>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card ">
							...
							<div class="card-footer bg-default">
								<a href="<?php echo site_url('main/show_materi/')?><?php echo $info->id_materi ?>" class="btn btn-primary btn-sm">  <i class="fa fa-share-square"></i> Detail Materi
								</a>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<code>Maaf, Guru belum memiliki materi apapun.</code>
					</div>
					<?php } ?>
